...
js_compress $DT_SRC/extensions/Plugins/integration/bootstrap/2/dataTables.bootstrap-datetimepicker.js
js_compress $DT_SRC/extensions/Plugins/integration/bootstrap/3/dataTables.bootstrap-datetimepicker.js
