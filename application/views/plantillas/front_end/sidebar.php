            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-medkit fa-fw"></i> Ordenes<span class="fa arrow"></span></a>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url()?>pacientes/nuevo-paciente">Nuevo</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url()?>pacientes/modificar-paciente">Modificar</a>
                                </li>
                            </ul>
                        </li>
                        <li>
